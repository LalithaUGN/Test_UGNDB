<%@ Page Title="R&D Test Issuance" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeFile="TestIssuanceDetail.aspx.vb" Inherits="TestIssuanceDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="maincontent" runat="server">
    ...
    <table>
        <tr>
            <td class="p_smalltextbold" style="width: 300px; color: #990000; height: 15px;">Edit data below or press
    ...
    <table>
        <tr>
            <td class="p_text">Test Issuance Request #:
            </td>
        ...
        <tr>
            ...
            <td style="height: 26px" colspan="3">
                ...
                <asp:RequiredFieldValidator ID="rfvSampleProdDesc" runat="server" ControlToValidate="txtSampleProdDesc"
                    ErrorMessage="Sample Product Description is a required field." Font-Bold="False" ForeColor="Red" Text="<" />
            </td>
        </tr>
        <tr>
            <td class="p_text" style="height: 26px">Request Status:
            </td>
        ...
        <tr>
            ...
            <td class="c_text" style="color: #990000; height: 26px">Check this box if Acoustic Testing is Required.
            </td>
            <td class="p_text">
    ...
    <table border="0">
        <tr>
            <td>
                <asp:Menu ID="mnuTabs" Height="30px" runat="server" Orientation="Horizontal" StaticEnableDefaultPopOutImage="false" RenderingMode="Table"
                    StaticMenuItemStyle-CssClass="tab" StaticSelectedStyle-CssClass="selectedTab"
                    CssClass="tabs">
                    <Items>
                        <asp:MenuItem Text="Request Info" Value="0" Selected="true" />
                        <asp:MenuItem Text="Customer / Part" Value="1" />
                        <asp:MenuItem Text="Administrative" Value="2" />
                        <asp:MenuItem Text="Assignments" Value="3" />
                        <asp:MenuItem Text="Test Reports" Value="4" />
                        <asp:MenuItem Text="Supporting Documents" Value="5"></asp:MenuItem>
                    </Items>
    ...
    <asp:MultiView ID="mvTabs" runat="server" Visible="true" ActiveViewIndex="0" EnableViewState="true">
        <asp:View ID="vwRequestInfoTab" runat="server">
            <table>
                <tr>
                    ...
                    <td style="height: 26px; width: 362px;">
                        ...
                        <asp:RequiredFieldValidator ID="rfvSampleIssuer" runat="server" ControlToValidate="ddSampleIssuer"
                            ErrorMessage="Sample Issuer is a required field." Font-Bold="False" ForeColor="Red" Text="<" />
                    </td>
                </tr>
                <tr>
                    <td class="p_text">Sample Issuer Department:
                    </td>
                ...
                <tr>
                    ...
                    <td style="width: 362px">
                        ...
                        <asp:RequiredFieldValidator ID="rfvUGNFacility" runat="server" ControlToValidate="ddUGNFacility"
                            ErrorMessage="UGN Location is a required field." Font-Bold="False" ForeColor="Red" Text="<" />
                    </td>
                </tr>
                <tr>
                    <td class="p_text">
                    ...
                    <td style="width: 362px">
                        ...
                        <asp:RequiredFieldValidator ID="rfvCommodity" runat="server" ControlToValidate="ddCommodity"
                            ErrorMessage="Commodity is a required field." Font-Bold="False" ForeColor="Red" Text="<" />
                    </td>
                </tr>
                <tr>
                    <td class="p_text">Purchased Good:
                    </td>
                    <td style="width: 362px">
                ...
                <tr>
                    <td class="p_text">General Material Thickness:
                    </td>
                    <td style="width: 362px">
                ...
                <tr>
                    <td class="p_text" style="white-space: nowrap; height: 26px">Quantity of Test Samples:
                    </td>
                ...
                <tr>
                    ...
                    <td style="width: 362px">
                        ...
                        <asp:RegularExpressionValidator ID="revTestCmpltDt" runat="server" ControlToValidate="txtTestCmpltDt"
                            ...
                            Width="8px" ForeColor="Red"><</asp:RegularExpressionValidator>
                ...
                <tr>
                    <td class="p_text" style="white-space: nowrap">Estimated Annual Cost Savings:
                    </td>
                    <td style="width: 362px">
                        ...
                        <asp:RangeValidator ID="rvEstAnnCostSav" runat="server" ControlToValidate="txtEstAnnCostSav"
                            ...
                            Height="16px" MaximumValue="999999.99" MinimumValue="-999999.99" Type="Double" ForeColor="Red"><</asp:RangeValidator>
            ...
            <table>
                <tr>
                    <td class="p_text" style="vertical-align: top; width: 213px">
                ...
                <%If HttpContext.Current.Request.QueryString("pReqCategory") <> 2 Then%>
                <tr>
                    <td class="p_text" style="width: 213px; vertical-align: top">Part Application/Market:
                    </td>
                    <td>
                ...
                <tr>
                    <td class="p_text" style="width: 213px; vertical-align: top">Objectives and Performance Targets:
                    </td>
                    <td>
                ...
                <tr>
                    <td class="p_text" style="width: 213px; vertical-align: top">Misc Agenda or Remaining Outstanding Items:
                    </td>
                    <td>
            ...
            <asp:ValidationSummary ID="vsRnD" runat="server" Font-Size="X-Small" ShowMessageBox="True" ShowSummary="true" ForeColor="Red" />
        </asp:View>
        <asp:View ID="vwCustomerPart" runat="server">
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddCustomer" runat="server" AppendDataBoundItems="true" AutoPostBack="true">
                        ...
                        <asp:RequiredFieldValidator ID="rfvCustomer" runat="server" ControlToValidate="ddCustomer"
                            ErrorMessage="Customer is a required field." Font-Bold="False" ValidationGroup="vsCustomerPart" ForeColor="Red"><</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="rfvProgram" runat="server" ControlToValidate="ddProgram"
                            ErrorMessage="Program is a required field." Font-Bold="False" ValidationGroup="vsCustomerPart" ForeColor="Red"><</asp:RequiredFieldValidator><br />
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="rfvPartNo" runat="server" ControlToValidate="txtPartNo"
                            ErrorMessage="Part No is a required field." Font-Bold="False" ValidationGroup="vsCustomerPart" ForeColor="Red"><</asp:RequiredFieldValidator>
                ...
                <tr>
                    <td class="p_text">DMS Drawing No:
                    </td>
                    <td>
                ...
                <tr>
                    <td class="p_text">Customer Spec No:
                    </td>
                    <td>
                ...
                <tr>
                    <td class="p_text">Manufacture Date:
                    </td>
                    <td>
                        ...
                        <asp:RegularExpressionValidator ID="revMfgDt" runat="server" ControlToValidate="txtMfgDt"
                            ErrorMessage='Invalid Date Entry:  use "mm/dd/yyyy" or "m/d/yyyy" format ' Font-Bold="True"
                            ToolTip="MM/DD/YYYY" ValidationExpression="^(((0?[1-9]|1[012])/(0?[1-9]|1\d|2[0-8])|(0?[13456789]|1[012])/(29|30)|(0?[13578]|1[02])/31)/(19|[2-9]\d)\d{2}|0?2/29/((19|[2-9]\d)(0[48]|[2468][048]|[13579][26])|(([2468][048]|[3579][26])00)))$"
                            Width="8px" ValidationGroup="vsCustomerPart" ForeColor="Red"><</asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
                    <td></td>
            ...
            <asp:ValidationSummary ID="vsCustomerPart" runat="server" Font-Size="X-Small" ShowMessageBox="True" ShowSummary="true" ValidationGroup="vsCustomerPart" ForeColor="Red" />
            <br />
            <br />
            ...
            <asp:ObjectDataSource ID="odsCustomerPart" runat="server" SelectMethod="GetTestIssuanceCustomerPart"
                OldValuesParameterFormatString="original_{0}" TypeName="RnDBLL"
        ...
        <asp:View ID="vwAdmin" runat="server" EnableTheming="False">
            <table>
                <tr>
                    <td class="p_text" style="vertical-align: top">Objective:
                    </td>
                    <td>
                ...
                <tr>
                    <td class="p_text" style="vertical-align: top">Status Notes:
                    </td>
                    <td>
                ...
                <tr>
                    <td class="p_text">Estimated Man Hours Remaining:
                    </td>
                    <td>
                        ...
                        <asp:RangeValidator ID="rvEstManHrs" runat="server" ControlToValidate="txtEstManHrs"
                            ...
                            Type="Double" ValidationGroup="vsAdmin" ForeColor="Red"><</asp:RangeValidator>
                        <ajax:FilteredTextBoxExtender ID="ftbeEstManHrs" runat="server" TargetControlID="txtEstManHrs"
                            FilterType="Custom, Numbers" ValidChars="-." />
                    </td>
                </tr>
                <tr>
                    <td class="p_text">Did Drawing Review Occur?
                    </td>
                    <td>
                ...
                <tr>
                    <td class="p_text">Testing Classification:
                    </td>
                    <td>
                ...
                <tr>
                    <td class="p_text">Longest Aging Cycle in hours:
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RegularExpressionValidator ID="revStartDt" runat="server" ControlToValidate="txtStartDt"
                            ErrorMessage='Invalid Date Entry:  use "mm/dd/yyyy" or "m/d/yyyy" format ' Font-Bold="True"
                            ToolTip="MM/DD/YYYY" ValidationExpression="^(((0?[1-9]|1[012])/(0?[1-9]|1\d|2[0-8])|(0?[13456789]|1[012])/(29|30)|(0?[13578]|1[02])/31)/(19|[2-9]\d)\d{2}|0?2/29/((19|[2-9]\d)(0[48]|[2468][048]|[13579][26])|(([2468][048]|[3579][26])00)))$"
                            Width="8px" ValidationGroup="vsAdmin" ForeColor="Red"><</asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
                    <td class="p_text">Projected Completion Date:
                    </td>
                    <td>
                        ...
                        <asp:RegularExpressionValidator ID="revProjCmplDt" runat="server" ControlToValidate="txtProjCmplDt"
                            ErrorMessage='Invalid Date Entry:  use "mm/dd/yyyy" or "m/d/yyyy" format ' Font-Bold="True"
                            ToolTip="MM/DD/YYYY" ValidationExpression="^(((0?[1-9]|1[012])/(0?[1-9]|1\d|2[0-8])|(0?[13456789]|1[012])/(29|30)|(0?[13578]|1[02])/31)/(19|[2-9]\d)\d{2}|0?2/29/((19|[2-9]\d)(0[48]|[2468][048]|[13579][26])|(([2468][048]|[3579][26])00)))$"
                            ValidationGroup="vsAdmin" Width="8px" ForeColor="Red"><</asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
                    <td class="p_text">Actual Completion Date:
                    </td>
                    <td>
            ...
            <asp:ValidationSummary ID="vsAdmin" runat="server" Font-Size="X-Small" ShowMessageBox="True" ShowSummary="true" ValidationGroup="vsAdmin" ForeColor="Red" />
            <br />
        </asp:View>
            ...
            <table>
                <tr>
                    <td colspan="2">
                                ...
                                <asp:TemplateField HeaderText="Team Member" SortExpression="TeamMemberID">
                                    ...
                                    <FooterTemplate>
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvTeamMember" runat="server" ControlToValidate="ddTeamMember"
                                            ErrorMessage="Team Member is a required field." Font-Bold="False" ValidationGroup="InsertTMInfo" ForeColor="Red"><</asp:RequiredFieldValidator>
                                    </FooterTemplate>
                                </asp:TemplateField>
                        ...
                        <asp:ValidationSummary ID="vsTMAssignments" runat="server" ValidationGroup="InsertTMInfo" ShowMessageBox="True" ForeColor="Red"/>
                        <asp:ObjectDataSource ID="odsTMAssignments" runat="server" DeleteMethod="DeleteTestIssuanceAssignments"
                            ...
                            SelectMethod="GetTestIssuanceAssignments" TypeName="RnDBLL">
                            <DeleteParameters>
                                <asp:QueryStringParameter Name="RequestID" QueryStringField="pReqID" Type="Int32" />
        ...
        <asp:View ID="vwTestReports" runat="server">
            <table>
                <tr>
                    <td class="p_text" style="width: 161px">Test Report #:
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="rfvReportIssuer" runat="server" ControlToValidate="ddReportIssuer"
                            ErrorMessage="Report Issuer is a required field." Font-Bold="False" ValidationGroup="vsTestReport" ForeColor="Red"><</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="p_text" style="width: 161px; vertical-align: top">
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="rfvTestDesc" runat="server" ControlToValidate="txtTestDesc"
                            ErrorMessage="Test Description is a required field." Font-Bold="False" ValidationGroup="vsTestReport" ForeColor="Red"><</asp:RequiredFieldValidator><br />
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="rfvAssessment" runat="server" ControlToValidate="txtAssessment"
                            ErrorMessage="Assessment is a required field." Font-Bold="False" ValidationGroup="vsTestReport" ForeColor="Red"><</asp:RequiredFieldValidator><br />
                        <asp:Label ID="lblAssessment" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
                    </td>
                </tr>
                <%If (ViewState("pRptID") > 0) Then%>
                <tr>
                    <td class="p_text" style="width: 161px; height: 26px; vertical-align: top">
                    ...
                    <td style="height: 26px">
                        ...
                        <asp:RequiredFieldValidator ID="rfvUpload" runat="server" ControlToValidate="uploadFile"
                            ErrorMessage="Test Report is required." Font-Bold="False" ValidationGroup="vsTestReport" ForeColor="Red"><</asp:RequiredFieldValidator><br />
                ...
                <%End If%>
                <tr>
                    <td class="p_text" style="width: 161px; height: 27px;"></td>
            ...
            <asp:ValidationSummary ID="vsTestReport" runat="server" ShowMessageBox="True" ValidationGroup="vsTestReport" ForeColor="Red" />
            <br />
                    ...
                    <asp:TemplateField ShowHeader="False">
                        <ItemTemplate>
                            <asp:HyperLink runat="server" ID="hlnkRptCoverSheet" ImageUrl="~/images/PreviewUp.jpg"
                                ...
                                Visible='<%# Bind("BinaryFound") %>' ToolTip="Preview Cover Sheet" BorderColor="Transparent" />
                        </ItemTemplate>
                    ...
                    <asp:TemplateField ShowHeader="False">
                        <ItemTemplate>
                            <asp:HyperLink runat="server" ID="hlnkPreview" ImageUrl='<%# DisplayImage(DataBinder.Eval(Container, "DataItem.EncodeType").tostring)  %>'
                                ...
                                Target="_blank" Visible='<%# Bind("BinaryFound") %>' ToolTip="Preview" BorderColor="Transparent" />
                        </ItemTemplate>
                        <HeaderStyle Width="30px" />
                        <ItemStyle HorizontalAlign="center" Width="30px" />
                    </asp:TemplateField>
            ...
            <asp:ObjectDataSource ID="odsTestReport" runat="server" DeleteMethod="DeleteTestIssuanceTestReport"
                ...
                <SelectParameters>
                    ...
                    <asp:Parameter DefaultValue="0" Name="TestReportID" Type="Int32" />
                </SelectParameters>
            </asp:ObjectDataSource>
        </asp:View>
