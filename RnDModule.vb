...
#Region "Test Issuance DB Methods"
    ...
    Public Shared Sub CleanRnDCrystalReports()
        ...
        Catch ex As Exception
            ...
            HttpContext.Current.Session("UGNErrorLastWebPage") = "~/Default.aspx"
...
#Region "Supporting Documents"
    Public Shared Function GetTestIssuanceSupportingDocList(ByVal RequestID As Integer) As DataSet

        Dim myConnection As SqlConnection = New SqlConnection
        Dim strConnectionString As String = System.Configuration.ConfigurationManager.ConnectionStrings("SQLConnection").ToString
        Dim strStoredProcName As String = "sp_Get_TestIssuance_Supporting_Doc_List"
        Dim myCommand As SqlCommand = New SqlCommand(strStoredProcName, myConnection)
        Dim GetData As New DataSet
        Dim myAdapter As New SqlDataAdapter
        ...
        Try
            ...
            GetTestIssuanceSupportingDocList = GetData
        Catch ex As Exception

            'on error, collect function data, error, and last page, then redirect to error page
            Dim strUserEditedData As String = "RequestID: " & RequestID & ", User: " & HttpContext.Current.Request.Cookies("UGNDB_User").Value

            HttpContext.Current.Session("BLLerror") = "GetTestIssuanceSupportingDocList: " & commonFunctions.convertSpecialChar(ex.Message, False) & " :<br/> RnDModule.vb :<br/> " & strUserEditedData
            HttpContext.Current.Session("UGNErrorLastWebPage") = "~/Default.aspx"
            UGNErrorTrapping.InsertErrorLog("GetTestIssuanceSupportingDocList: " & commonFunctions.convertSpecialChar(ex.Message, False), "RnDModule.vb", strUserEditedData)

            HttpContext.Current.Response.Redirect("~/UGNError.aspx", False)

            GetTestIssuanceSupportingDocList = Nothing
    ...
    End Function ''Eof GetTestIssuanceSupportingDocList
    Public Shared Function GetTestIssuanceSupportingDoc(ByVal RowID As Integer, ByVal RequestID As Integer) As DataSet

        Dim myConnection As SqlConnection = New SqlConnection
        Dim strConnectionString As String = System.Configuration.ConfigurationManager.ConnectionStrings("SQLConnection").ToString
        Dim strStoredProcName As String = "sp_Get_TestIssuance_Supporting_Doc"
        Dim myCommand As SqlCommand = New SqlCommand(strStoredProcName, myConnection)
        Dim GetData As New DataSet
        Dim myAdapter As New SqlDataAdapter
        ...
        Try
            ...
            GetTestIssuanceSupportingDoc = GetData
        Catch ex As Exception

            'on error, collect function data, error, and last page, then redirect to error page
            Dim strUserEditedData As String = "RequestID: " & RequestID & ", User: " & HttpContext.Current.Request.Cookies("UGNDB_User").Value

            HttpContext.Current.Session("BLLerror") = "GetTestIssuanceSupportingDoc : " & commonFunctions.convertSpecialChar(ex.Message, False) & " :<br/> RnDModule.vb :<br/> " & strUserEditedData
            HttpContext.Current.Session("UGNErrorLastWebPage") = "~/Default.aspx"
            UGNErrorTrapping.InsertErrorLog("GetTestIssuanceSupportingDoc : " & commonFunctions.convertSpecialChar(ex.Message, False), "RnDModule.vb", strUserEditedData)

            HttpContext.Current.Response.Redirect("~/UGNError.aspx", False)

            GetTestIssuanceSupportingDoc = Nothing
    ...
    End Function  '''' EOF GetTestIssuanceSupportingDoc
    Public Shared Sub InsertTestIssuanceSupportingDocument(ByVal RequestID As Integer, ByVal SupportingDocName As String, _
   ...
   ByVal SupportingDocEncodeType As String)
        ...
        Dim myConnection As SqlConnection = New SqlConnection
        Dim strConnectionString As String = System.Configuration.ConfigurationManager.ConnectionStrings("SQLConnection").ToString
        Dim strStoredProcName As String = "sp_Insert_TestIssuance_Supporting_Doc"
        Dim myCommand As SqlCommand = New SqlCommand(strStoredProcName, myConnection)
        ...
        Catch ex As Exception
            'on error, collect function data, error, and last page, then redirect to error page
            Dim strUserEditedData As String = "RequestID: " & RequestID _
            ...
            HttpContext.Current.Session("BLLerror") = "InsertTestIssuanceSupportingDocument: " _
            & commonFunctions.convertSpecialChar(ex.Message, False) & " :<br/> RnDModule.vb :<br/> " & strUserEditedData

            HttpContext.Current.Session("UGNErrorLastWebPage") = "~/Default.aspx"
            UGNErrorTrapping.InsertErrorLog("InsertTestIssuanceSupportingDocument: " & commonFunctions.convertSpecialChar(ex.Message, False), "RnDModule.vb", strUserEditedData)
    ...
    End Sub '''''' EOF GetTestIssuanceSupportingDoc
#End Region
